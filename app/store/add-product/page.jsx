    ...
    const handleImageUpload = async (key, file) => {
        ...
        if(key === '1' && file && !aiUsed) {
            ...
            reader.onloadend = async () => {
                ...
                try {
                    await toast.promise(
                        axios.post('/api/store/ai', { base64Image: base64String, mimeType: mineType }, {
                            headers: {                   
                        ...
                        }),
                        {
                            ...
                            success: (res) => {
                                ...
                                if(data.name && data.description) {
                                    ...
                                    setAiUsed(true)
                                    return "Product details generated with Ai"
                                }
                                return "Ai could not generate product details"
                            },
